        ...
        <div class="max-w-[1200px] mx-auto flex-row-reverse	 flex flex-wrap ">
            ...
            <div class="flex-0-0-75 max-w-[75%] flex-col">
                ...
                <div class="grid grid-cols-3 gap-2 mb-10">
                    <!-- Kart Başlangıcı -->
                    <div
                        class="box-border  w-[300px] h-[450px] flex flex-col  my-[50px]  transform transition duration-500 hover:scale-90">
                        <form class="box-border ">
                            <div class="bg-white text-center my-[-5px] mx-[10px] border-2 shadow-md rounded-lg ">
                                ...
                                <span
                                    class="bg-[#f9f9f9] rounded-[3px] text-[#555] leading-[1px] pt-[6px] pr-[14px] pb-[5px] relative top-[-10px] z-[99]">
                                    SK: 054 25100
                                </span>
                                <hr class="my-2.5 p-0 mt-[30px] mr-0">
                                <div class="text-center">
                                    <div class="pt-[3px] mt-[10px] px-[15px] pb-[15px]">
                                        <div>
                                            <a href="#" class="text-[#454545] transition-all">Kablo Bağı 2,5x100
                                                Beyaz</a>
                                        </div>
                                        <div class="block mt-[60px]">
                                            <div class="absolute top-0 p-0">
                                            </div>
                                        </div>
                                        <div>
                                            <span
                                                class="rounded-[3px] left-[15px] mt-[30px] leading-[2px] py-[6px] pr-[6px] z-[99] text-[16px] text-[#333]">
                                                STOK TÜKENDİ
                                            </span>
                                        </div>
                                        <hr class="my-2.5 p-0 mt-[10px] mr-0">
                                        <div class="flex flex-wrap justify-center mt-0 mr-[-10px]">
                                            <a href="#"
                                                class="flex mb-[10px] mr-[10px] bg-[#eef0f1] text-[#242424] rounded-[3px] text-[12px] font-medium pt-[9px] pr-[25px] pb-[8px] uppercase">
                                                <img src="img/shopping-cart.svg" class="h-4 w-4 mr-2"> SEPETE EKLE
                                            </a>
                                            <a href="#"
                                                class="flex mb-2.5 rounded-[3px] bg-[#eef0f1] text-[#242424] text-[12px] font-medium pt-[9px] pr-[25px] pb-[8px] uppercase">
                                                <img src="img/search2.svg" class="h-4 w-4 mr-2"> İNCELE
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div
                        class="box-border w-[300px] h-[450px] flex flex-col my-[50px] transform transition duration-500 hover:scale-90">
                        <form class="box-border">
                            <div class="bg-white text-center my-[-5px] mx-[10px]">
                                <div class="relative">
                                    <div class="box-border min-h-[245px]">
                                        <a href="#">
                                            <img src="img/ürün.jpg" alt="" class="w-full h-full object-cover">
