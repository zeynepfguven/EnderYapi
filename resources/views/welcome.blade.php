...
<body class="overflow-x-hidden">
    ...
    <section class="border-b border-[#ebebeb]">
        ...
        <div class="box-border overflow-x-hidden mb-2.5">
            <div class="w-full block z-[1] relative">
                <div class="relative box-border block">
                    <div class="transform-custom transition-all-custom w-custom">
                        <div class="w-[2136px] float-left backface-hidden touch-callout-none">
                            <div class="min-h-[515px] bg-center bg-cover pb-40 bg-slider1">
                                <div class="top-0 absolute w-full h-full z-[999] bg-pattern"></div>
                            </div>
                        </div>
                        <div class="w-[2136px] float-left">
                            <div class="min-h-[515px] bg-cover bg-center pb-40 bg-slider2">
                                <div class="top-0 absolute w-full h-full z-[999] bg-pattern"></div>
                            </div>
                        </div>
                        <div class="w-[2136px] float-left">
                            <div class="min-h-[515px] bg-cover bg-center pb-40 bg-slider3">
                                <div class="top-0 absolute w-full h-full z-[999] bg-pattern"></div>
                            </div>
                        </div>
                    </div>
