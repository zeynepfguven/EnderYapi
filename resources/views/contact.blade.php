            ...
            <div class="max-w-[1200px] mx-auto ">
                <div class="box-border">
                    <ul class="m-0 p-0">
                        ...
                        <li class="text-[#2f4264] inline-block text-sm mr-7 relative box-border">
                            <a href="#" class="text-[#242424]">İletişim</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section class="pb-10 pt-10 mb-10 mt-10 box-border ">
            <div class="max-w-[1200px] mx-auto">
                <div class="flex flex-wrap mr-[-15px] ml-[-15px] box-border ">
                    <div class="box-border pb-[15px] mb-[30px]  ">
                        <h2 class="text-4xl font-medium mb-6 pb-7 relative uppercase"> İletişim - ENDER YAPI MALZEMELERİ
                    ...
                    <div class="fitem-center flex-col flex-0-0-33 max-w-[33.33%]  ">
                        ...
                        <div class="box-border ">
                            ...
                            <p class="">Halkalı Merkez Mh. Fatih Cd. Fırat Sk. No.: 7 <br>Küçükçekmece / İstanbul</p>
                            <br>
                        </div>
                        <div class="box-border  ">
                            <h2 class="text-xl font-medium">Telefon</h2>
                            <p class="">0212 495 31 89<br>0 212 495 31 87</p><br>
                        </div>
                        <div class="box-border ">
                            <h2 class="text-xl font-medium">E-Mail</h2>
                            <p class="">destek@enderyapi.com.tr</p><br>
                        </div>
                        <div class="box-border ">
                            <h2 class="text-xl font-medium">Vergi Dairesi</h2>
                            <p class="">Halkalı<br>3340058723</p>
                        </div>


                    </div>
                    <div
                        class="item-center flex flex-0-0-66 max-w-[66.66%] relative w-full pr-[15px] pl-[15px] min-h-[1px]">
                        <div class="w-full h-full">
                            <iframe class="w-full h-full"
                                src="https://maps.google.com/maps?width=780&amp;height=406&amp;hl=en&amp;q=Halkal%C4%B1%20Merkez%20Mh.%20Fatih%20Cd.%20F%C4%B1rat%20Sk.%20No.%20%3A%207%20%20K%C3%BC%C3%A7%C3%BCk%C3%A7ekmece%20%2F%20%C4%B0STANBUL+(ENDER%20YAPI%20MALZEMELER%C4%B0%20%C4%B0N%C5%9E.%20TAAH.%20SAN.%20VE%20T%C4%B0C.%20LTD.%20%C5%9ET%C4%B0.)&amp;ie=UTF8&amp;t=&amp;z=10&amp;iwloc=B&amp;output=embed"
                ...
                <div class="swiper-wrapper ">
                    ...
                    <script>
                        var swiper = new Swiper(".multiple-slide-carousel", {
                            loop: true,
                            slidesPerView: 3, // Görünmesini istediğiniz kart sayısı
                            spaceBetween: 20, // Kartlar arasındaki boşluk
                            navigation: {
